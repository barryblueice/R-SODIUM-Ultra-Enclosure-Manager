...
class Ui_main_interface(object):
    def setupUi(self, main_interface):
        ...
        self.label_4.setGeometry(QRect(225, 355, 61, 31))
        font3 = QFont()
        ...
        self.label_3.setGeometry(QRect(25, 355, 141, 31))
        ...
        self.powertime.setGeometry(QRect(158, 356, 60, 31))
        ...
        self.label_21.setGeometry(QRect(30, 290, 250, 2))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 297, 800))
        self.scrollAreaWidgetContents.setMinimumSize(QSize(100, 800))
        ...
        self.boxmode_execute.setGeometry(QRect(200, 740, 91, 41))
        ...
        self.label_12.setGeometry(QRect(70, 230, 171, 31))
        self.label_12.setFont(font)
        self.label_12.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.selfpowered_groupbox = QGroupBox(self.scrollAreaWidgetContents)
        self.selfpowered_groupbox.setObjectName(u"selfpowered_groupbox")
        self.selfpowered_groupbox.setGeometry(QRect(20, 270, 131, 161))
        self.selfpowered_groupbox.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.nvme_self_power_checkbox = QCheckBox(self.selfpowered_groupbox)
        self.nvme_self_power_checkbox.setObjectName(u"nvme_self_power_checkbox")
        self.nvme_self_power_checkbox.setGeometry(QRect(30, 38, 83, 21))
        self.nvme_self_power_checkbox.setChecked(True)
        self.nvme_self_power_checkbox.setAutoExclusive(False)
        self.sata1_self_power_checkbox = QCheckBox(self.selfpowered_groupbox)
        self.sata1_self_power_checkbox.setObjectName(u"sata1_self_power_checkbox")
        self.sata1_self_power_checkbox.setGeometry(QRect(30, 68, 83, 21))
        self.sata1_self_power_checkbox.setChecked(True)
        self.sata1_self_power_checkbox.setAutoExclusive(False)
        self.sata2_self_power_checkbox = QCheckBox(self.selfpowered_groupbox)
        self.sata2_self_power_checkbox.setObjectName(u"sata2_self_power_checkbox")
        self.sata2_self_power_checkbox.setGeometry(QRect(30, 98, 83, 21))
        self.sata2_self_power_checkbox.setChecked(True)
        self.sata2_self_power_checkbox.setAutoExclusive(False)
        self.extpowered_groupbox = QGroupBox(self.scrollAreaWidgetContents)
        self.extpowered_groupbox.setObjectName(u"extpowered_groupbox")
        self.extpowered_groupbox.setGeometry(QRect(159, 270, 131, 161))
        self.extpowered_groupbox.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.sata1_ext_power_checkbox = QCheckBox(self.extpowered_groupbox)
        self.sata1_ext_power_checkbox.setObjectName(u"sata1_ext_power_checkbox")
        self.sata1_ext_power_checkbox.setGeometry(QRect(30, 68, 83, 21))
        self.sata1_ext_power_checkbox.setChecked(True)
        self.sata1_ext_power_checkbox.setAutoExclusive(False)
        self.sata2_ext_power_checkbox = QCheckBox(self.extpowered_groupbox)
        self.sata2_ext_power_checkbox.setObjectName(u"sata2_ext_power_checkbox")
        self.sata2_ext_power_checkbox.setGeometry(QRect(30, 98, 83, 21))
        self.sata2_ext_power_checkbox.setChecked(True)
        self.sata2_ext_power_checkbox.setAutoExclusive(False)
        self.nvme_ext_power_checkbox = QCheckBox(self.extpowered_groupbox)
        self.nvme_ext_power_checkbox.setObjectName(u"nvme_ext_power_checkbox")
        self.nvme_ext_power_checkbox.setGeometry(QRect(30, 38, 83, 21))
        self.nvme_ext_power_checkbox.setChecked(True)
        self.nvme_ext_power_checkbox.setAutoExclusive(False)
        self.label_13 = QLabel(self.scrollAreaWidgetContents)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(30, 210, 250, 2))
        ...
        self.nvmeonly.setGeometry(QRect(20, 40, 231, 31))
        ...
        self.combinemode.setGeometry(QRect(20, 10, 231, 31))
        ...
        self.hubonly.setGeometry(QRect(20, 100, 231, 31))
        ...
        self.sataonly.setGeometry(QRect(20, 70, 231, 31))
        self.sataonly.setFont(font1)
        self.sataonly.setAutoExclusive(True)
        self.label_14 = QLabel(self.scrollAreaWidgetContents)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(30, 460, 250, 2))
        ...
        self.suspend_enable = QCheckBox(self.scrollAreaWidgetContents)
        self.suspend_enable.setObjectName(u"suspend_enable")
        self.suspend_enable.setGeometry(QRect(40, 520, 231, 31))
        self.suspend_enable.setFont(font1)
        self.suspend_enable.setAutoExclusive(True)
        self.unmounted_suspend_enable = QCheckBox(self.scrollAreaWidgetContents)
        self.unmounted_suspend_enable.setObjectName(u"unmounted_suspend_enable")
        self.unmounted_suspend_enable.setGeometry(QRect(40, 560, 231, 31))
        self.unmounted_suspend_enable.setFont(font1)
        ...
        self.apply_changes_immediately.setGeometry(QRect(50, 670, 211, 41))
        ...
        self.reset_execute = QPushButton(self.overview)
        self.reset_execute.setObjectName(u"reset_execute")
        self.reset_execute.setGeometry(QRect(170, 290, 121, 41))
        font7 = QFont()
        font7.setPointSize(9)
        self.reset_execute.setFont(font7)
...
"may not support this function!", None))
        ...
        self.selfpowered_groupbox.setTitle(QCoreApplication.translate("main_interface", u"Self-Powered", None))
        ...
        self.extpowered_groupbox.setTitle(QCoreApplication.translate("main_interface", u"Ext-Powered", None))
...
"unsafe shutdowns count.", None))
        self.suspend_enable.setText(QCoreApplication.translate("main_interface", u"Enable enclosure suspend when\n"
"host is suspended.", None))
...
"for better stability and performance.", None))
        self.reset_execute.setText(QCoreApplication.translate("main_interface", u"Reset Controller", None))
