...
################################################################################
## Form generated from reading UI file 'ultra_ssdbox_manager.ui'
##
...
class Ui_main_interface(object):
    def setupUi(self, main_interface):
        ...
        self.overview_button.setGeometry(QRect(20, 120, 131, 51))
        font1 = QFont()
        ...
        self.SATA_Interface_button.setGeometry(QRect(20, 240, 131, 51))
        ...
        self.boxmode_button.setGeometry(QRect(20, 180, 131, 51))
        ...
        self.about_button.setGeometry(QRect(20, 300, 131, 51))
        ...
        self.sataconfig.setGeometry(QRect(170, 10, 311, 341))
        font2 = QFont()
        ...
        self.sata_execute.setGeometry(QRect(200, 280, 91, 41))
        ...
        self.storageconfig.setGeometry(QRect(20, 210, 261, 21))
        ...
        self.boxmode_execute.setGeometry(QRect(200, 280, 91, 41))
        self.overview = QGroupBox(main_interface)
        self.overview.setObjectName(u"overview")
        self.overview.setGeometry(QRect(170, 9, 311, 341))
        self.about = QGroupBox(main_interface)
        self.about.setObjectName(u"about")
        self.about.setGeometry(QRect(170, 10, 311, 341))
    ...
    def retranslateUi(self, main_interface):
        ...
        self.label_4.setText(QCoreApplication.translate("main_interface", u"second.", None))
