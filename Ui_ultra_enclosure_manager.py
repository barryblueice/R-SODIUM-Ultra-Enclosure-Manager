...
class Ui_main_interface(object):
    def setupUi(self, main_interface):
        ...
        self.unmounted_suspend_enable.setGeometry(QRect(40, 530, 231, 31))
        ...
        self.reset_execute.setGeometry(QRect(160, 290, 121, 41))
        font7 = QFont()
        font7.setPointSize(9)
        self.reset_execute.setFont(font7)
        self.dfu_reset_execute = QPushButton(self.overview)
        self.dfu_reset_execute.setObjectName(u"dfu_reset_execute")
        self.dfu_reset_execute.setGeometry(QRect(30, 290, 121, 41))
        self.dfu_reset_execute.setFont(font7)
...
"for better stability and performance.", None))
        ...
        self.dfu_reset_execute.setText(QCoreApplication.translate("main_interface", u"DFU Update", None))
